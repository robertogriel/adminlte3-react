const Aside = ()=>{
    return (
        ...
        <img src="assets/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" className="brand-image img-circle elevation-3" style={{
            opacity: .8
        }} />
        ...
        <nav className="mt-2">
            ...
            <li className="nav-item">
                ...
                <li className="nav-item">
                    <a href="assets/index.html" className="nav-link">
                    <i className="far fa-circle nav-icon"></i>
                    <p>Dashboard v1</p>
                    </a>
                </li>
                <li className="nav-item">
                    <a href="assets/index2.html" className="nav-link">
                    <i className="far fa-circle nav-icon"></i>
                    <p>Dashboard v2</p>
                    </a>
                </li>
                <li className="nav-item">
                    <a href="assets/index3.html" className="nav-link">
                    <i className="far fa-circle nav-icon"></i>
                    <p>Dashboard v3</p>
                    </a>
                </li>
            ...
            <li className="nav-item menu-open">
                ...
                <li className="nav-item">
                    <a href="assets/starter.html" className="nav-link">
                    <i className="far fa-circle nav-icon"></i>
                    <p>Starter Page</p>
                    </a>
                </li>
            ...
            <li className="nav-item">
                <a href="assets/iframe.html" className="nav-link">
